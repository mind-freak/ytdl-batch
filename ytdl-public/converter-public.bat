@echo off
cls
echo THIS WILL CONVERT ALL THE MUSIC FILES INSIDE THIS FOLDER TO .OGG / VORBIS TO THE FOLDER "OGG";
echo IF "OGG" DOESN'T EXIST, IT WILL BE CREATED; FFMPEG AND THE MUSIC FILES MUST BE WITH THE CONVERTER;
