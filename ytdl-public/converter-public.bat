@echo off
cls
# THIS WILL CONVERT ALL THE MUSIC FILES INSIDE THIS FOLDER TO .OGG / VORBIS TO THE FOLDER "OGG"; IF "OGG" DOESN'T EXIST, IT WILL BE CREATED; FFMPEG AND THE MUSIC FILES MUST BE WITH THE CONVERTER; CHOOSE THE FILE TYPE YOU WANNA CONVERT TO OGG.
